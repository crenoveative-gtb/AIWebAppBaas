...
export default function ContentRepurposePage() {
  ...
  const [maxTokens, setMaxTokens] = useState(2600);
        ...
        <div className="space-y-5 xl:col-span-5">
          <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              ...
              <textarea value={sourceText} onChange={(e) => setSourceText(e.target.value)} placeholder="Source text fallback (optional)" className="input-modern min-h-[96px] resize-y text-xs" />
