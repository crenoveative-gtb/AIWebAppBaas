...
export default function DashboardPage() {
    ...
    const loadLibraryStats = useCallback(async () => {
        try {
            ...
            const prompts = promptsRes.success && promptsRes.data?.prompts ? promptsRes.data.prompts.length : 0;
            const agents = agentsRes.success && agentsRes.data?.agents ? agentsRes.data.agents.length : 0;
