...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'References', icon: 'bi-book', path: '/references' }
    ]
  }
];
    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-950' : 'bg-[#f8f9fc]'} transition-colors duration-300`}>
      ...
      <div className="flex">
        ...
        >
          ...
          {/* Sidebar footer */}
          {!sidebarCollapsed && (
            <div className={`absolute bottom-0 left-0 right-0 p-3 border-t ${darkMode ? 'border-gray-800 bg-gray-900/80' : 'border-gray-100 bg-gray-50/50'}`}>
              <p className="text-center text-[10px] text-gray-400">v2.0 · Build 2026</p>
            </div>
          )}
        </aside>
